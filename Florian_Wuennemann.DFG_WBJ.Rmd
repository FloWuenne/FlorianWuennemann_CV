...
csl: https://forum.paperpile.com/uploads/default/original/1X/c28acabfd239a53dcf3d45a21b8dbf7f7cafe87a.csl
...
tribble(~time, ~award, ~place,
        ...
        "2019/10","Abstract prize: Semifinalist 2019 Charles J. Epstein Trainee Awards for Excellence in Human Genetics Research","Houston, Texas, USA",
...
vitae::bibliography_entries(here("./data/references.bib")) %>%
  arrange(desc(issued))
```
